                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="toolbar-contact">
                                <ul>
                                    <li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:info@solhapp.com">info@solhapp.com</a></li>
                                    <li><i class="fa fa-phone" aria-hidden="true"></i><a href="tel:8595370108">(+91)-859 537 0108</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="toolbar-sl-share">
                                <ul>
                                    <!-- <li class="opening">  <marquee> <i class="flaticon-clock"></i>Meet Us at Modern Public School, Shalimar Bagh on Dec 16th</marquee></li> -->
