<footer id="rs-footer" class="rs-footer">
            <div class="container">
                ...
                <div class="footer-content pt-62 pb-50 md-pb-64 sm-pt-48">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 md-mb-32 footer-widget">
                            ...
                            <ul class="implinks f-column">
                                ...
                                <li>
                                    <i class="fa fa-angle-right" aria-hidden="true"></i>
                                    <a href="https://solhapp.com/blog/" target="_blank">Blog</a>
                                </li>                                 
                            </ul>
                ...
                <div class="footer-bottom">
                    <div class="row y-middle">
                        <div class="col-lg-6 col-md-8 sm-mb-21">
                            <div class="copyright">
                                <p>© Copyright 2022 Solhapp. All Rights Reserved.</p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-4 text-right sm-text-center">
                            <ul class="footer-social">
                            <li><a href="https://www.instagram.com/solhappofficial/?utm_medium=copy_link" target="_blank"><i class="fa fa-instagram"></i></a></li>
