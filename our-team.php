                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-sm-6 mb-30">
                            <h2>Our Team</h2>
                            <p>Our passion fuels the energy to solve what others fail at. The experience, the expertise and a like-minded team certainly helps. Our sincere belief is that most people can improve their mental health if equipped with the right tools, unrelated buddies and a non-judgmental, committed safe space. We are a team with problem-solution approach. We bring fresh ideas, innovative solutions, and perspectives to all our engagements. Our relentless focus in forging bold ideas helps our users achieve superior outcomes in competitive environments.</p>
                        </div>
                    </div>
                    <div class="row">
                            <div class="col-lg-4 col-sm-6 mb-30">
                                <div class="team-wrap">
                                    <a href="#" data-toggle="modal" data-target="#kapil">
                                        <div class="team-img"><img src="images/kg.jpg" alt=""></div>
                                        <div class="team-item-text">
                                        <div class="team-details">
                                        <h3 class="team-name">Kapil Gupta</h3>
                                        <span class="team-title">Co-Founder & CEO</span>
                                        </div>
                                        </div>
                                    </a>

                                    <div class="modal fade" id="kapil">
                                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">Kapil Gupta</h5>
                            ...
                            <div class="col-lg-4 col-sm-6 mb-30">
                                <div class="team-wrap">
                                    <a href="#" data-toggle="modal" data-target="#pranav">
                                        <div class="team-img">
                                        <img src="images/pranavgupta.jpg" alt="">
                                        </div>
                                        <div class="team-item-text">
                                        <div class="team-details">
                                        <h3 class="team-name">Pranav Gupta</h3>
                                        <span class="team-title">Co-Founder</span>
                                        </div>
                                        </div>
                                    </a>

                                    <div class="modal fade" id="pranav">
                                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">Pranav Gupta</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                                </button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-sm-3 mb-30"><img src="images/pranavgupta.jpg" alt=""></div>
                                                        <div class="col-lg-9 col-sm-9 mb-30">
                                                            <p>Pranav Gupta is the co-founder of Solh and he truly believes that mental health must be addressed with equal attention just like any other illness. In the same context, he passionately believes that all health insurance policies must include the treatment of mental health issues, which is currently not the case. Insurance policies seem to be very indifferent towards mental health, and skin and eye treatments. He believes that once the government supports and covers everything around Mental Health requirements, the country can really grow at a fast pace while matching the global economy.</p>
                                                        </div>
                                                    </div>
                                                    <p>Pranav Gupta is also the MD of Prints Publications and the Co-Founder of Frontlist Media, the #1 platform and magazine representing the Indian publishing industry. He is the Elected Executive Committee Member of the International Publishers Association (IPA), Joint Secretary of the Federation of Indian Publishers, and the Secretary-General of the Indian Reprographic Rights Organization (IRRO).</p>
                                                    <p>A third-generation publisher, Pranav grew Prints Publications multi-fold not just in revenue but also in reputation and global markets. Pranav takes pride in being one of the limited publishers who’ve not used the power of digital & tech but created multiple brands around it.</p>
                                                    <p>He believes that the needs of India, global exposure, changing education dynamics and the unlimited powers of digital are some of the key tenets which need to be sewn together before we foray into a new decade. Which is why he deem his candidature/nomination for IPA as one of the most pivotal opportunities that can shape the future of publishing, education digitisation across industries.</p>
                                                </div>
                            ...
                            <div class="col-lg-4 col-sm-6 mb-30">
                                <div class="team-wrap">
                                    <a href="#" data-toggle="modal" data-target="#Tarun">
                                        <div class="team-img">
                                        <img src="images/tarun.jpg" alt="">
                                        </div>
                                        <div class="team-item-text">
                                        <div class="team-details">
                                        <h3 class="team-name">Dr Tarun Sehgal </h3>
                                        <!-- <span class="team-title">Divisional Director & Senior Psychiatrist</span> -->
                                        <span class="team-title">Co-Founder</span>
                                        </div>
                                        </div>
                                    </a>

                                    <div class="modal fade" id="Tarun">
                                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">Dr Tarun Sehgal</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                                </button>
                                                </div>
